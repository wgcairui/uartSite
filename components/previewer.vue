<template>
  ...
  <div class="pswp vue-picture-preview" tabindex="-1" role="dialog" aria-hidden="true">
    ...
    <div class="pswp__scroll-wrap">
      ...
      <div class="pswp__ui pswp__ui--hidden">
        <div class="pswp__top-bar">
          ...
          <!-- <button class="pswp__button">选中</button> -->
        ...
        <span class=" pt-5 pl-5 text-light">{{name}}</span>
  ...
  methods: {
    ...
    doInit(index) {
      ...
      this.photoswipe.listen("gettingData", function(index, item) {
        data.name = decodeURI(item.name)
        //console.log({a:data,index, item});
